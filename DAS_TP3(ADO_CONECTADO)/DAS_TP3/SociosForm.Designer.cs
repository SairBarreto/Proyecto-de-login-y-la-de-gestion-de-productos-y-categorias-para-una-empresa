namespace DAS_TP3
{
    partial class SociosForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            dgvInfoSocios = new DataGridView();
            btnModificarEnBD = new Button();
            btnBorrarEnBD = new Button();
            btnAgregarEnBD = new Button();
            ((System.ComponentModel.ISupportInitialize)dgvInfoSocios).BeginInit();
            SuspendLayout();
            // 
            // label1
            // 
            ...
            label1.TabIndex = 6;
            label1.Text = "Información Socios";
            // 
            // dgvInfoSocios
            // 
            dgvInfoSocios.AllowUserToAddRows = false;
            dgvInfoSocios.AllowUserToDeleteRows = false;
            dgvInfoSocios.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            ...
            dgvInfoSocios.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            dgvInfoSocios.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            ...
            dgvInfoSocios.DefaultCellStyle = dataGridViewCellStyle2;
            dgvInfoSocios.Location = new Point(130, 34);
            dgvInfoSocios.Name = "dgvInfoSocios";
            dgvInfoSocios.ReadOnly = true;
            dgvInfoSocios.Size = new Size(658, 150);
            dgvInfoSocios.TabIndex = 5;
            // 
            // btnModificarEnBD
            // 
            btnModificarEnBD.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnModificarEnBD.Location = new Point(12, 106);
            btnModificarEnBD.Name = "btnModificarEnBD";
            btnModificarEnBD.Size = new Size(112, 30);
            btnModificarEnBD.TabIndex = 12;
            ...
            Controls.Add(label1);
            Controls.Add(dgvInfoSocios);
            Name = "SociosForm";
            Text = "Socios";
            FormClosed += SociosForm_FormClosed;
            Load += SociosForm_Load;
            ((System.ComponentModel.ISupportInitialize)dgvInfoSocios).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private DataGridView dgvInfoSocios;
